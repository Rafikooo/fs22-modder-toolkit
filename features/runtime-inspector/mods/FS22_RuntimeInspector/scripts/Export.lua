-- Export.lua (Facade/Factory pattern)
-- Responsible for: Export configuration and processor chain management
-- SRP: Provides unified interface to export subsystem, manages processors
-- Delegates actual export work to ExportSingle and ExportBatch
