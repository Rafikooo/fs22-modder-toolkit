...
-- Get base output directory for exports
...
-- NOTE: Reading files is NOT allowed in FS22 (io.open read mode is forbidden)
-- These functions are commented out as they won't work:
-- function FileSystem.readFile(path) - NOT SUPPORTED
-- function FileSystem.fileExists(path) - NOT SUPPORTED

-- Create simple export directory (no sessions, no versioning)
-- Returns: outputDir
