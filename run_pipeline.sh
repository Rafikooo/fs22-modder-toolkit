...
_CLI_INSTALL_DOCS_DEPS="${INSTALL_DOCS_DEPS:-}"
_CLI_BUILD_DOCS_SITE="${BUILD_DOCS_SITE:-}"
...
[[ -n "$_CLI_INSTALL_DOCS_DEPS" ]] && INSTALL_DOCS_DEPS="$_CLI_INSTALL_DOCS_DEPS"
[[ -n "$_CLI_BUILD_DOCS_SITE" ]] && BUILD_DOCS_SITE="$_CLI_BUILD_DOCS_SITE"
